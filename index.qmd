...
# Downsampling approaches generate distinct network structures

Here we can actually look at the topology and see if the different networks actually look different in multivariate space? Despite similar target connectance and richness, networks differed strongly in higher-order structure.
