...
**Pairwise contrasts of topological extinction $R_{50}$ at network creation between network types for the different extinction scenarios for the different communities**

![](../figures/contrasts/robustnessContrasts_topo_creation.png)

**Pairwise contrasts of topological extinction $R_{50}$ after burn-in between network types for the different extinction scenarios for the different communities**

![](../figures/contrasts/robustnessContrasts_topo_realised.png)

**Pairwise contrasts of dynamic extinction $R_{50}$ between network types for the different extinction scenarios for the different communities**
...
**Cluster analyses for topological extinction $R_{50}$ at network creation for the different communities**

![](../figures/clustering/robustnessClusters_topo_creation.png)

**Cluster analyses for topological extinction $R_{50}$ after burn-in for the different communities**

![](../figures/clustering/robustnessClusters_topo_realised.png)

**Cluster analyses for dynamic extinction $R_{50}$ for the different communities**
